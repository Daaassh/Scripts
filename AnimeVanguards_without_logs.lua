...
local creatorId = 17219742
local placeId = 16146832113
--  or (identifyexecutor and identifyexecutor():find("Fluxus") 
if game.CreatorId ~= creatorId or game.PlaceId == placeId or not getgenv or not getgenv or not getupvalues or not require or not assert or not setmetatable or not loadstring or not isfile or not readfile or not delfile or not writefile or not isfolder or not delfolder or not listfiles or not makefolder or not firesignal or (getgenv and (getgenv().LoadedFluentCrazyDay or getgenv().LoadingAnimeVanguards)) then
    return
else
